...
class Neteller implements PaymentMethodInterface
{
    ...
    {
        return PaymentMethodEnum::PME_NETELLER_WALLET;
    }

    public static function getChannels(): array
    {
        return [PaymentChannelEnum::PCL_NETELLER_WALLET->value => new \DevLancer\Zen\Payment\Channel\Neteller()];
    }
}