...
class Paysafecash implements \DevLancer\Zen\Payment\PaymentChannelInterface
{
    ...
    {
        return [CurrencyEnum::EUR, CurrencyEnum::CAD, CurrencyEnum::BGN, CurrencyEnum::CZK, CurrencyEnum::HUF, CurrencyEnum::GBP, CurrencyEnum::USD, CurrencyEnum::PLN, CurrencyEnum::MXN, CurrencyEnum::RON, CurrencyEnum::SEK, CurrencyEnum::CHF];
    }
    ...
    {
        return PaymentChannelEnum::PCL_PAYSAFECASH;
    }
